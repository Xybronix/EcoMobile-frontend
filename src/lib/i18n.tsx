...
const translations: Translations = {
  ...
  'users.deposit': { fr: 'Dépôt de garantie', en: 'Security deposit' },
  ...
  'users.mostActive': { fr: 'Les plus actifs', en: 'Most active' },
  ...
  'users.noScoresYet': { fr: 'Aucun score pour le moment', en: 'No scores yet' },
